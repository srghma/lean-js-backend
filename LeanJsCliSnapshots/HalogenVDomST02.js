...
const assertEqual = /* #__PURE__ */ Assert.assertEqual({ eq: /* #__PURE__ */ Data$dEq.eqArrayImpl(ra => rb => ra.a === rb.a && ra.b === rb.b) })({
  show: /* #__PURE__ */ Data$dShow.showArrayImpl(record => "{ a: " + Data$dShow.showStringImpl(record.a) + ", b: " + record.b.toString() + " }")
});
const assertEqual3 = /* #__PURE__ */ Assert.assertEqual({ eq: /* #__PURE__ */ Data$dEq.eqArrayImpl(ra => rb => ra.a === rb.a && ra.b === rb.b && ra.ix === rb.ix) })({
  show: /* #__PURE__ */ Data$dShow.showArrayImpl(record => "{ a: " + Data$dShow.showStringImpl(record.a) + ", b: " + record.b.toString() + ", ix: " + record.ix.toString() + " }")
});
const main = () => {
  const merged1 = [];
  const added1 = [];
