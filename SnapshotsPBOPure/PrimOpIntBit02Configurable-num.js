...
export const TestUSize_shiftRight = (() => {
  ...
  return $lean_usize_shift_right(v0, 2);
})();
...
export const TestInt64_xor = (() => {
  const v0 = $lean_int64_of_nat(15);
  const v1 = $lean_int64_of_nat(12);
  return $lean_int64_xor(v0, v1);
})();
export const TestInt64_shiftRight = (() => {
  const v0 = $lean_int64_of_nat(1023);
...
export const TestInt64_lor = (() => {
  const v0 = $lean_int64_of_nat(16);
  const v1 = $lean_int64_of_nat(15);
  return $lean_int64_lor(v0, v1);
})();
export const TestInt64_land = (() => {
  const v0 = $lean_int64_of_nat(1023);
  const v1 = $lean_int64_of_nat(8);
...
export const TestInt_complement = (() => {
  const v0 = $lean_int_neg(3);
  return Int_not(v0);
})();
export const TestISize_xor = (() => {
  const v0 = $lean_isize_of_nat(15);
  const v1 = $lean_isize_of_nat(12);
  return $lean_isize_xor(v0, v1);
})();
export const TestISize_shiftRight = (() => {
  const v0 = $lean_isize_of_nat(1023);
...
export const TestISize_lor = (() => {
  const v0 = $lean_isize_of_nat(16);
  const v1 = $lean_isize_of_nat(15);
  return $lean_isize_lor(v0, v1);
})();
export const TestISize_land = (() => {
  const v0 = $lean_isize_of_nat(1023);
  const v1 = $lean_isize_of_nat(8);
