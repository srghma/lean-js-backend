// Tests of `PrimOpInt01NonConfigurable.js`: `PrimOpInt01NonConfigurable.lean` compiled with the default
...
// `scripts/expectations/PrimOpInt01NonConfigurable.json` holds and Lean itself wrote
...
import * as m from "./PrimOpInt01NonConfigurable.js";

checkModule(m, "PrimOpInt01NonConfigurable", "num", { inexact: 0, divergent: [] });

test("no BigInt is used", () => {
  const src = readFileSync(new URL("./PrimOpInt01NonConfigurable.js", import.meta.url), "utf8");
