// Tests of `PrimOpIntBit02NonConfigurable.js`: `PrimOpIntBit02NonConfigurable.lean` compiled with the default
...
// `scripts/expectations/PrimOpIntBit02NonConfigurable.json` holds and Lean itself wrote
...
import * as m from "./PrimOpIntBit02NonConfigurable.js";

checkModule(m, "PrimOpIntBit02NonConfigurable", "num", { inexact: 0, divergent: [] });

test("no BigInt is used", () => {
  const src = readFileSync(new URL("./PrimOpIntBit02NonConfigurable.js", import.meta.url), "utf8");
