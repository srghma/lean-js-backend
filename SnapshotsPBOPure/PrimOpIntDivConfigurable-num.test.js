// Tests of `PrimOpIntDivConfigurable-num.js`: `PrimOpIntDivConfigurable.lean` compiled
// with `--config=pbo`, where `Nat`, `Int`, `USize`, `UInt64`, `Int64` and `ISize` are
// JavaScript numbers.
//
...
import * as m from "./PrimOpIntDivConfigurable-num.js";
