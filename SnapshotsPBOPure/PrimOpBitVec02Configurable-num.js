...
export const TestBitVec64_shiftRight = (v0, v1) => {
  const v2 = BitVec_toNat(64, v1);
  return BitVec_ushiftRight(64, v0, v2);
};
export const TestBitVec64_shiftLeft = (v0, v1) => {
  const v2 = BitVec_toNat(64, v1);
  return BitVec_shiftLeft(64, v0, v2);
};
...
export const TestBitVec32_shiftRight = (v0, v1) => {
  const v2 = BitVec_toNat(32, v1);
  return BitVec_ushiftRight(32, v0, v2);
};
export const TestBitVec32_shiftLeft = (v0, v1) => {
  const v2 = BitVec_toNat(32, v1);
  return BitVec_shiftLeft(32, v0, v2);
};
