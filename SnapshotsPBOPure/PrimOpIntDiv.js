...
const main = /* #__PURE__ */ (() => {
  const $0 = Assert.assertEqual(Data$dEq.eqInt)(Data$dShow.showInt)("div1")({
    expected: 0,
    actual: divNoInline(1)(0),
  });
  return () => {
    $0();
    Assert.assertEqual(Data$dEq.eqInt)(Data$dShow.showInt)("div2")({
      expected: 1,
      actual: divNoInline(3)(2),
    })();
    return Assert.assertEqual(Data$dEq.eqInt)(Data$dShow.showInt)("div3")({
      expected: -1,
      actual: divNoInline(3)(-2),
    })();
  };
