...
export const TestBitVec64_shiftRight = (
  v0,
  v1,
) => BitVec_ushiftRight(64n, v0, BitVec_toNat(64n, v1));
export const TestBitVec64_shiftLeft = (
  v0,
  v1,
) => BitVec_shiftLeft(64n, v0, BitVec_toNat(64n, v1));
...
export const TestBitVec32_shiftRight = (
  v0,
  v1,
) => BitVec_ushiftRight(32n, v0, BitVec_toNat(32n, v1));
export const TestBitVec32_shiftLeft = (
  v0,
  v1,
) => BitVec_shiftLeft(32n, v0, BitVec_toNat(32n, v1));
