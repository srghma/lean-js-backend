// Tests of `PrimOpIntBit01NonConfigurable.js`: `PrimOpIntBit01NonConfigurable.lean` compiled with the default
...
// `scripts/expectations/PrimOpIntBit01NonConfigurable.json` holds and Lean itself wrote
...
import * as m from "./PrimOpIntBit01NonConfigurable.js";

checkModule(m, "PrimOpIntBit01NonConfigurable", "num", { inexact: 0, divergent: [] });

test("no BigInt is used", () => {
  const src = readFileSync(new URL("./PrimOpIntBit01NonConfigurable.js", import.meta.url), "utf8");
